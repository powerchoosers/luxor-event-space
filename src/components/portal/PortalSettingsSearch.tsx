...
const SETTINGS_SEARCH_ITEMS: SettingsSearchItem[] = [
  ...
  { tab: 'notifications', section: 'Notifications', title: 'Automated notifications', description: 'Review automatic inquiry and email alert behavior.', keywords: 'automation alerts reminders zoho email bookings inquiries' },
  ...
  { tab: 'integrations', section: 'Integrations', title: 'Zoho email connection', description: 'Configure real-time Zoho email notifications and reconnect the mailbox.', keywords: 'zoho mail webhook inbox reconnect oauth integration email' },
