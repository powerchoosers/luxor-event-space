  ...
  return (
    <body data-portal-theme={portalTheme} className="h-screen overflow-hidden bg-[color:var(--portal-bg)] font-sans text-[color:var(--portal-muted)] selection:bg-[#caa24c]/30">
      ...
      <main className={`flex h-screen flex-col transition-[padding] duration-300 ease-[cubic-bezier(0.23,1,0.32,1)] ${sidebarCollapsed ? 'lg:pl-20' : 'lg:pl-64'} ${elenaOpen ? 'lg:pr-[420px]' : 'lg:pr-0'}`}>
        ...
        <div className={`portal-scrollbar min-h-0 flex-1 flex flex-col ${pathname === '/portal/leads' ? 'overflow-y-hidden' : 'overflow-y-auto'} overflow-x-hidden p-4 sm:p-6 lg:p-8 ${
          portalTheme === 'light'
