...
export async function GET(request: Request) {
  ...
  try {
    ...
    const refreshTokenLine = setup.refreshToken
      ...
      : 'ZOHO_REFRESH_TOKEN=Zoho did not return one. Reopen /api/auth/zoho/login and approve again.'
    const envBlock = [
      ...
      <html lang="en">
        ...
        <body>
          <main>
            ...
            <p>Copy these values into Vercel. Locally, add the same values to <strong>.env.local</strong> if they are missing or outdated.</p>
