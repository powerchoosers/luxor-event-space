...
const venueStructuredData = {
  ...
  '@type': 'EventVenue',
  name: 'Luxor at Las Palmas Events',
...
export const metadata: Metadata = {
  ...
  title: {
    default: 'Luxor at Las Palmas Events | San Antonio Weddings & Celebrations',
    template: '%s | Luxor at Las Palmas Events',
  },
  description: 'A modern San Antonio event venue for weddings, quinceañeras, and private celebrations at Luxor at Las Palmas Events.',
  keywords: ['San Antonio event venue', 'San Antonio wedding venue', 'Quinceañera venue', 'private event space', 'corporate event venue'],
  openGraph: {
    type: 'website',
    locale: 'en_US',
    siteName: 'Luxor at Las Palmas Events',
    title: 'Luxor at Las Palmas Events | San Antonio Weddings & Celebrations',
  ...
  twitter: {
    ...
    title: 'Luxor at Las Palmas Events | San Antonio',
