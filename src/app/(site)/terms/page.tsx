...
const sections = [
  ...
  ['Luxor Event Space SMS program', 'If you provide a mobile number and check the text-message consent box, you agree to receive customer-care and occasional promotional texts from Luxor Event Space about your inquiry, tour, booking, payment, event, or Luxor open-house invitation. Message frequency varies. Message and data rates may apply. Reply STOP to opt out at any time or HELP for help. Consent is not a condition of purchase. Mobile carriers are not liable for delayed or undelivered messages. For assistance, email booking@luxoratlaspalmas.com.'],
