        ...
        <div className="relative z-10 mx-auto grid max-w-7xl gap-12 lg:grid-cols-[0.92fr_1.08fr] lg:items-center">
          <div className="max-w-2xl">
            ...
            <div className="mt-9 flex flex-col gap-3 sm:flex-row">
              <Link href="/visit#visit-booking" data-conversion="visit_cta_click" data-conversion-label="Spaces hero" className="inline-flex items-center justify-center gap-2 rounded-md border border-[#f1d27a]/45 bg-[#caa24c] px-5 py-3 text-sm font-bold uppercase tracking-[0.14em] text-[#050505]">
      ...
      <section className="bg-[#050505] py-16 sm:py-24 lg:py-28">
        <div className="mx-auto grid max-w-7xl gap-10 px-5 sm:px-6 lg:grid-cols-[1.05fr_0.95fr] lg:items-center lg:px-8">
          ...
          <Reveal delay={120}>
            ...
            <Link href="/visit#visit-booking" data-conversion="visit_cta_click" data-conversion-label="Spaces details" className="mt-8 inline-flex items-center justify-center gap-2 rounded-md border border-[#f1d27a]/45 bg-[#caa24c] px-5 py-3 text-sm font-bold uppercase tracking-[0.14em] text-[#050505]">
              Schedule a Visit <ArrowRight className="h-4 w-4" />
            </Link>
          </Reveal>
        </div>
