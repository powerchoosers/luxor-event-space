...
const sections = [
  ...
  ['Text messages', 'When you provide a mobile number and check the text-message consent box, Luxor Event Space may send customer-care messages about your inquiry, tour, booking, payment, or event, plus occasional promotional messages such as Luxor open-house invitations. Message frequency varies. Message and data rates may apply. Reply STOP to opt out or HELP for help. Consent to text messages is not a condition of purchase.'],
  ['Marketing messages', 'We send promotional email and text messages only when you have opted in. Marketing messages include an unsubscribe or STOP option. Customer-care messages about a request, tour, proposal, contract, payment, or booked event may still be sent when necessary and when permitted by the communication preference you provided.'],
