...
export async function buildLuxorDateLockDepositEmail(input: {
  ...
  return {
    subject: `Secure your date for Luxor Event Space — ${money(input.depositAmount)} deposit`,
    html: `<!doctype html><html><body style="margin:0;background:#050505;color:#f7efe3;font-family:Arial,sans-serif"><table role="presentation" width="100%"><tr><td align="center" style="padding:28px 14px"><table role="presentation" width="620" style="width:100%;max-width:620px;background:#0a0807;border:1px solid rgba(202,162,76,.28)"><tr><td style="height:4px;background:#caa24c"></td></tr><tr><td align="center" style="padding:30px 40px;border-bottom:1px solid rgba(202,162,76,.18)"><div style="font-family:Georgia,serif;color:#caa24c;font-size:30px;letter-spacing:.18em">LUXOR</div><div style="margin-top:6px;color:#8c754f;font-size:8px;letter-spacing:.35em">AT LAS PALMAS EVENTS</div></td></tr><tr><td style="padding:44px 42px"><div style="color:#caa24c;font-size:10px;font-weight:700;letter-spacing:.25em;text-transform:uppercase">Date Reservation Deposit</div><h1 style="font-family:Georgia,serif;font-size:34px;line-height:1.12;margin:14px 0 18px">Lock in ${escapeHtml(eventDate)} for your celebration</h1><p style="font-size:15px;line-height:1.75;color:#d7c29a">Hi ${escapeHtml(firstName)}, we are thrilled to host your ${escapeHtml(eventType)} at Luxor Event Space. Submit your date-lock deposit below to officially reserve ${escapeHtml(eventDate)} on our calendar. Once secured, we will schedule your Planning Meeting to customize your layout, decor, and remaining invoice details.</p><div style="margin:26px 0;padding:20px;border:1px solid rgba(202,162,76,.18);background:#0d0b09"><p style="margin:0 0 8px;color:#caa24c;font-size:10px;font-weight:700;letter-spacing:.2em;text-transform:uppercase">Date-Lock Deposit</p><p style="margin:0;font-family:Georgia,serif;font-size:32px;color:#f1d27a">${money(input.depositAmount)}</p><p style="margin:8px 0 0;color:#9f9079;font-size:12px">Reserves ${escapeHtml(eventDate)} · Balance & remaining options finalized during Planning Meeting</p></div><p style="margin:30px 0"><a href="${escapeHtml(input.reviewUrl)}" style="display:inline-block;background:#caa24c;color:#17120c;text-decoration:none;padding:16px 28px;font-size:11px;font-weight:800;letter-spacing:.16em;text-transform:uppercase">Secure Your Event Date</a></p><p style="font-size:12px;line-height:1.7;color:#9f9079">Questions or adjustments? Reply directly to this email and our team will assist you.</p></td></tr></table></td></tr></table></body></html>`,
  }
}
